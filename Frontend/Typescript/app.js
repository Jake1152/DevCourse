...
for (var _i = 0, mergedArray_1 = mergedArray; _i < mergedArray_1.length; _i++) {
    var element = mergedArray_1[_i];
    console.log("tuple element : ".concat(element));
}
console.log();
// Spread 연산자 적용
var mergedArrayUsingSpread = __spreadArray(__spreadArray([], firstArray, true), secondArray, true);
for (var _a = 0, mergedArrayUsingSpread_1 = mergedArrayUsingSpread; _a < mergedArrayUsingSpread_1.length; _a++) {
    var element = mergedArrayUsingSpread_1[_a];
    console.log("tuple element : ".concat(element));
}
console.log();
